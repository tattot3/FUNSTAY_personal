...
<table id="host1">
<tr><td><h1 id="host">호스트 등록</h1></td></tr>
<tr><td>숙소 이름</td></tr>
<tr><td><input type="text" size="100"></td></tr>
<tr><td>숙소 설명(주의사항,규칙, 기타 정보 등을 적어주세요)</td></tr>
<tr><td><textarea rows="10" cols="100" name="txt"></textarea></td></tr>
...
<label for="upload" class="upload-hidden" id="upload-hidden"><h1 class="plus">+</h1><h5 class="up">사진업로드</h5></label>
<input type="file" id="upload" name="upload">
<label for="upload" class="upload-hidden"><h1 class="plus">+</h1><h5 class="up">사진업로드</h5></label>
<input type="file" id="upload" name="upload">
<label for="upload" class="upload-hidden"><h1 class="plus">+</h1><h5 class="up">사진업로드</h5></label>
<input type="file" id="upload" name="upload">
<label for="upload" class="upload-hidden"><h1 class="plus">+</h1><h5 class="up">사진업로드</h5></label>
<input type="file" id="upload" name="upload">
<label for="upload" class="upload-hidden"><h1 class="plus">+</h1><h5 class="up">사진업로드</h5></label>
<input type="file" id="upload" name="upload"></td></tr>
...
<tr><td><input type="button" value="수정완료" class="btn"></td></tr>
</table>
</form>
